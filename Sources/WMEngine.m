...
static BOOL ValidSettings(id s) {
 ...
 for(NSString *k in @[@"watermarkEnabled",@"keepOriginal",@"gridEnabled",@"mirrorFront",@"flashMode",@"timerSeconds"])if(s[k]&&![s[k] isKindOfClass:NSNumber.class])return NO;
...
- (NSMutableDictionary *)defaults {return [@{@"schemaVersion":@1,@"watermarkEnabled":@YES,@"layers":[self presets][0][@"layers"],@"tone":@{@"brightness":@0,@"contrast":@1,@"saturation":@1,@"warmth":@0},@"keepOriginal":@NO,@"gridEnabled":@YES,@"mirrorFront":@YES,@"flashMode":@0,@"timerSeconds":@0,@"userTemplates":@[]} mutableCopy];}
- (instancetype)init {
 if((self=[super init])){
